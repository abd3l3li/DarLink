...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    long countByRecipientAndReadFalseAndTypeAndRoomId(User recipient, String type, Long roomId);
    List<Notification> findAllByRecipientAndTypeAndRoomIdAndReadFalse(User recipient, String type, Long roomId);
}